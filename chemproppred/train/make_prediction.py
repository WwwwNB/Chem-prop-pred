...
# from chemprop.sklearn_predict import predict
from chemproppred.train.predict import predict
from chemprop.args import PredictArgs, TrainArgs
from chemprop.data import get_data, get_data_from_smiles, get_header, MoleculeDataLoader, MoleculeDataset
from chemproppred.train.utils import load_args, load_checkpoint, load_scalers, makedirs, timeit
...
def make_predictions(args: PredictArgs, smiles: List[List[str]] = None) -> List[List[Optional[float]]]:
    ...
    for checkpoint_path in tqdm(args.checkpoint_paths, total=len(args.checkpoint_paths)):
        ...
        # Make predictions
        model_preds = predict(          #! change in the 
            model=model,
            # model_type='MoleculeModel',
            data_loader=test_data_loader,
            # dataset_type='regression',
            # features=test_data_loader,
            scaler=scaler
        )
